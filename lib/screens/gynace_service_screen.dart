...
class GynaceSurgeyServiceScreen extends StatefulWidget {
  final int id;

  GynaceSurgeyServiceScreen({Key key, this.id})
      : super(
          key: key,
        );

  @override
  _GynaceSurgeyServiceScreen createState() => _GynaceSurgeyServiceScreen();
}

class _GynaceSurgeyServiceScreen extends State<GynaceSurgeyServiceScreen> {
        ...
        Positioned(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/gynace.jpeg'),
